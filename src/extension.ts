...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
	...
	context.subscriptions.push(vscode.commands.registerCommand('git-helper.refresh', async () => {
		// vscode.window.showInformationMessage('Hello World from Git Helper!');
		// HelloWorldPanel.createOrShow(context.extensionUri);
		// HelloWorldPanel.kill();
		// HelloWorldPanel.createOrShow(context.extensionUri);
		await vscode.commands.executeCommand("workbench.action.closeSidebar");
		await vscode.commands.executeCommand("workbench.view.extension.git-helper-sidebar-view");
